...
import { Text, View, Alert, SafeAreaView, FlatList, StyleSheet,Platform, StatusBar,ImageBackground,Image,Dimensions} from 'react-native';
...
export default class MeteorsScreen extends Component {
  ...
  getMeteors=()=>{
    axios
        .get("https://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-08&api_key=EjMN62vofZ4jufwWjFTxcw3bVMyrV49X0XtI6l2U")
        .then(response=>{
  ...
  renderItem=({item})=>{
    ...
    return(
      ...
      <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>
      Velocity(km/h)- {item.close_approach_data[0].relative_velocity.kilometer_per_hour}
      </Text>
